...
import { InputType, DataType, Metadata, Attribute, Token, Action, ActionTruncated } from "@/config/types"
...
export const parseChainId = (chainId: string | undefined): 5003 | 11155111 | 31337 | undefined => {
  // console.log("@parseChainId: waypoint 0", {chainId})
  if (!chainId) {
    return undefined
  }
  if (chainId !== "5003" && chainId !== "11155111" && chainId !== "31337") {
    return undefined
  }
  return parseInt(chainId) as 5003 | 11155111 | 31337 | undefined
}
